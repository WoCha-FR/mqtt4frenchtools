...
describe('getMeteoVigilance', () => {
  ...
  test('should return correct data with no additional 1', async () => {
    const res = { vigiCrue: 'Jaune', vigiCrue1: '', vigiCrue1D: '', vigiCrue1F: '', vigiCrueD: 1700110800, vigiCrueF: 1700262000, vigiFroid: 'Vert', vigiFroid1: '', vigiFroid1D: '', vigiFroid1F: '', vigiFroid2: '', vigiFroid2D: '', vigiFroid2F: '', vigiFroidD: 1700110800, vigiFroidF: 1700262000, vigiNeige: 'Vert', vigiNeige1: '', vigiNeige1D: '', vigiNeige1F: '', vigiNeige2: '', vigiNeige2D: '', vigiNeige2F: '', vigiNeigeD: 1700110800, vigiNeigeF: 1700262000, vigiOrage: 'Vert', vigiOrage1: 'Jaune', vigiOrage1D: 1700143200, vigiOrage1F: 1700262000, vigiOrage2: '', vigiOrage2D: '', vigiOrage2F: '', vigiOrageD: 1700110800, vigiOrageF: 1700229600, vigiPluie: 'Vert', vigiPluie1: '', vigiPluie1D: '', vigiPluie1F: '', vigiPluie2: '', vigiPluie2D: '', vigiPluie2F: '', vigiPluieD: 1700110800, vigiPluieF: 1700262000, vigiVent: 'Vert', vigiVent1: 'Jaune', vigiVent1D: 1700128800, vigiVent1F: 1700172000, vigiVent2: 'Vert', vigiVent2D: 1700172000, vigiVent2F: 1700218800, vigiVentD: 1700110800, vigiVentF: 1700128800 }
    const spy1 = jest.spyOn(logger, 'warn')
  ...
  test('should return correct data with no additional 3', async () => {
    const res = { vigiCrue: 'Jaune', vigiCrue1: '', vigiCrue1D: '', vigiCrue1F: '', vigiCrueD: 1700110800, vigiCrueF: 1700262000, vigiFroid: 'Vert', vigiFroid1: '', vigiFroid1D: '', vigiFroid1F: '', vigiFroid2: '', vigiFroid2D: '', vigiFroid2F: '', vigiFroidD: 1700110800, vigiFroidF: 1700262000, vigiNeige: 'Vert', vigiNeige1: '', vigiNeige1D: '', vigiNeige1F: '', vigiNeige2: '', vigiNeige2D: '', vigiNeige2F: '', vigiNeigeD: 1700110800, vigiNeigeF: 1700262000, vigiOrage: 'Vert', vigiOrage1: 'Jaune', vigiOrage1D: 1700143200, vigiOrage1F: 1700262000, vigiOrage2: '', vigiOrage2D: '', vigiOrage2F: '', vigiOrageD: 1700110800, vigiOrageF: 1700229600, vigiPluie: 'Vert', vigiPluie1: '', vigiPluie1D: '', vigiPluie1F: '', vigiPluie2: '', vigiPluie2D: '', vigiPluie2F: '', vigiPluieD: 1700110800, vigiPluieF: 1700262000, vigiVent: 'Vert', vigiVent1: 'Jaune', vigiVent1D: 1700218800, vigiVent1F: 1700244000, vigiVent2: 'Vert', vigiVent2D: 1700244000, vigiVent2F: 1700262000, vigiVentD: 1700172000, vigiVentF: 1700218800 }
    const spy1 = jest.spyOn(logger, 'warn')
    const spy2 = jest.spyOn(eventEmitter, 'emit').mockImplementation(() => {})
    jest.useFakeTimers({ now: new Date(2023, 10, 16, 23, 5) })
    await client.getMeteoVigilance('42', 'vigimet', 'testretour1')
    expect(spy1).not.toHaveBeenCalled()
    expect(spy2).toHaveBeenCalledWith('frame', 'vigimet/vigilance', res)
  })
  ...
  test('should return correct data with vagues 1', async () => {
    const res = { vigiCrue: 'Vert', vigiCrue1: '', vigiCrue1D: '', vigiCrue1F: '', vigiCrueD: 1700110800, vigiCrueF: 1700262000, vigiVague: 'Vert', vigiVague1: 'Jaune', vigiVague1D: 1700110800, vigiVague1F: 1700157600, vigiVague2: 'Vert', vigiVague2D: 1700157600, vigiVague2F: 1700262000, vigiVagueD: 1700089200, vigiVagueF: 1700110800 }
    const spy1 = jest.spyOn(logger, 'warn')
    const spy2 = jest.spyOn(eventEmitter, 'emit').mockImplementation(() => {})
    jest.useFakeTimers({ now: new Date(2023, 10, 16, 7, 5) })
  ...
  test('should return correct data with vague 5 dpt06', async () => {
    const res = { vigiAvalanche: 'Vert', vigiAvalanche1: '', vigiAvalanche1D: '', vigiAvalanche1F: '', vigiAvalanche2: '', vigiAvalanche2D: '', vigiAvalanche2F: '', vigiAvalancheD: 1700110800, vigiAvalancheF: 1700262000, vigiVague: 'Vert', vigiVague1: 'Jaune', vigiVague1D: 1700143200, vigiVague1F: 1700229600, vigiVague2: 'Vert', vigiVague2D: 1700143200, vigiVague2F: 1700262000, vigiVagueD: 1700092800, vigiVagueF: 1700143200 }
    const spy1 = jest.spyOn(logger, 'warn')
    const spy2 = jest.spyOn(eventEmitter, 'emit').mockImplementation(() => {})
    jest.useFakeTimers({ now: new Date(2023, 10, 16, 1, 5) })
